 ...
 * @author WARREN
 */
public class DVenta_detalle implements Operaciones{
    private String table="venta_detalle";
    @Override
    public String insertar(Object o) {
        CVenta_detalle x=(CVenta_detalle) o;        
    ...
    public ArrayList listar() {
       ...
       CVenta_detalle x=new CVenta_detalle();
       conecion con=new conecion(table);        
       DBCursor cursor=con.get_colletion().find();
        try{
            while(cursor.hasNext()){      
                x=new CVenta_detalle();
